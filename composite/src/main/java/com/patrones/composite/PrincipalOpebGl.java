...
public class PrincipalOpebGl {

	// The window handle
	static private long window;
	
	static Graficos graficos = new Graficos();
	...
	static private void init() {
		...
		// Create the window
		window = glfwCreateWindow(800, 600, "Composte", NULL, NULL);
		if (window == NULL)
	...
	public static void main(String[] args) {
		...
		System.setProperty("org.lwjgl.librarypath", "C:/Users/Kelly/Documents/Workspace/EclipseProjects24/ogl");
		PrincipalOpebGl.run();
	}
